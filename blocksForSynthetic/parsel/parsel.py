...
# Used to parse a Parsel str to a target language
def parsel_str(codegen, program, target_file=None, allow_autofill=False, should_expand=False, debug=False, add_name_and_args=False):
    ...
    # Write the compiled program to a file
    return write_to_file(target_file, defined_fns)
